...
def user_menu():
    ...
    update_user_button.grid(column=0, row=0, padx=10, pady=10)  # Add the button to the window
    ...
    deregister_button.grid(column=0, row=1, padx=10, pady=10)  # Add the button to the window
...
def deregister_gui():
    ...
    # Create a deregister button
    button = tk.Button(root, text="Deregister", command=lambda: deregister(identifier_type.get(), identifier.get()), font=("Arial", 14), bg=button_color, fg=fg)
